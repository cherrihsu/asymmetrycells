# -*- coding: utf-8 -*-
"""
This program reads the npy datafile generated from scan_ss.py and makes plots.
"""
import numpy as np
...
DIR = "./"
data=np.load(DIR + "scan_ss_data.npy", allow_pickle=True)
...
T = np.reshape(uss, (m_size,m_size))
X = np.reshape(mss, (m_size,m_size))
...
ax.set_xlabel('$u_{ss}$ (nM)', size = 18)
ax.set_ylabel('$m_{ss}$ (nM)', size = 18)
ax.set_xscale("log")
ax.set_yscale("log")
